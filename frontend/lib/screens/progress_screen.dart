...
class _ProgressScreenState extends State<ProgressScreen> {
  ...
  int _computeQuizAvg(List<QuizResult> history) {
    ...
    final total = history.fold<int>(
      0,
      (sum, q) => sum + q.scorePercent.round(),
    );
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          ...
          style: GoogleFonts.nunito(fontSize: 14, color: AppColors.luxuryText),
        ),
      ],
    );
  }
        ...
        return Wrap(
          ...
          children: [
            _statCard(
              width: cardWidth,
              icon: '\u{1F4D8}',
              iconBg: AppColors.luxuryBrown.withValues(alpha: 0.10),
  ...
  Widget _buildWeeklyChartCard(
    ...
    return WeeklyChart(days: activity, currentXp: currentXp, weeklyXpGoal: 500);
  }
      ...
      children: [
        ...
        if (badges.isEmpty)
          ...
          Wrap(
            ...
            runSpacing: 16,
            children: badges
                .map((b) => _badgeItem(b.icon, b.name, b.locked))
                .toList(),
          ),
      ],
    );
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: locked ? AppColors.luxuryBorder : AppColors.luxuryGold,
                width: 2,
              ),
              color: locked
          ...
          Text(
            ...
            style: GoogleFonts.nunito(
              fontSize: 11,
              fontWeight: FontWeight.w600,
              color: locked ? AppColors.luxuryTextHint : AppColors.luxuryText,
            ),
          ),
        ],
      ),
